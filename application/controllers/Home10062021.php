...
class Home extends CI_Controller {
    ...
    public function index($curPage=0)
	{
        ...
        */
        ...
        $header['site_settings']->site_title = 'Flat Iron Holdings - '.$header['site_settings']->site_title;
    ...
    public function getfreevaluation(){
        ...
        $header['site_settings']->site_title = 'Get Apprised - '.$header['site_settings']->site_title;
        //print '<pre>';
