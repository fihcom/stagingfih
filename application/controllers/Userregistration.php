...
class Userregistration extends CI_Controller
{
        ...
        if ($res['status'] === true) {
            ...
            if ($userDetails['role'] == 'admin') {
                $sessionArray = array(
                    ...
                    'fullname' => $userDetails['name']." ".$userDetails['lastname'],
                    'lastLogin' => '',
                    'roleText' => 'admin',
    ...
    public function registerUser()
    {
        ...
        $rr = $this->input->post('captcha-response');
        // echo $secretKey.' - '.$rr;
        // die;
    
        // $verifyResponse = file_get_contents('https://www.google.com/recaptcha/api/siteverify?secret='.$secretKey.'&response='.$rr);
        // echo $verifyResponse;
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://www.google.com/recaptcha/api/siteverify?secret='.$secretKey.'&response='.$rr.'',
