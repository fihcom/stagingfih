						...
						<div class="sell-site-wrap mt30">
							<div class="js-tabs sell-site-tab" data-aos="fade-left" data-aos-duration="2400">
								<nav>
									...
									<li id="tabarea5" class="<?php echo $selectedtab5; ?>" data-tab-id='tab5'>Comments</li>
								...
								<div class='panels'>
									...
									<div id='tab5' class='content'>
										<h2 class="blue-heading text-center">To expedite our vetting process, please provide any extra relevant details.</h2>
										<div class="income-details-list extra-info-list">
											<ul class="ul row"> 
												<li class="col-md-12">
													<div class="box">
														<h2 class="subhead">Before you submit your application, tell us anything else that we may need to know to better understand the value & health of your business.</h2>
														<!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum aliquam velit risus, at fermentum mi ultrices vitae. Curabitur pellentesque suscipit arcu ut fermentum. </p>-->
