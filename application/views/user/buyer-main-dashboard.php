						...
						<div class="dashboard-wrap mt30">
							<div class="js-tabs" data-aos="fade-left" data-aos-duration="2400">
								<nav>
									...
									<li data-tab-id='tab6'>Answers</li>
											...
											foreach($sellerListing as $rb)
											{
												...
												<?php
													...
													<div class="row">
														...
														<div class="col-md-10 latest-list-middleCol">
																...
																<div class="mid-block d-flex justify-content-between">
																	<div class="block">
																		...
																		<span>
																		<?php 
																			$datajsonarr = json_decode($rb['data_json'],true);
																			$m=0;
																			if(is_array($datajsonarr['website']) && count($datajsonarr['website'])>0)
																			{
																				foreach($datajsonarr['website'] as $v)
																				{
																					$websitedata = $v;
																					$websitedata = str_replace('http://','',$websitedata);
																					$websitedata = str_replace('https://','',$websitedata);
																					$websitedata = str_replace('www.','',$websitedata);
																					$stringlength = strlen($websitedata);
																					$websitedata = substr($websitedata,0,30);
																					$websitedata = ($stringlength>30)?$websitedata.'...':$websitedata;
																					if($m==0)
																					{
																						echo '<a href="'.$v.'" target="_blank">'.$websitedata.'</a>';
																					}else{
																						echo '<br><a href="'.$v.'" target="_blank">'.$websitedata.'</a>';
																					}
																					$m++;
																				}
																			}
