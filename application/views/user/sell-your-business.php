							...
							<div class="js-tabs sell-site-tab" data-aos="fade-left" data-aos-duration="2400">
								...
								<div class='panels'>
									...
									<div id='tab3' class='content'>
										...
										<div class="income-details-list">
											...
											<ul class="ul row">
												<li class="col-md-4">
													<div class="box">
														<h2 class="subhead">Last Month</h2>
														<!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum aliquam velit risus, at fermentum mi ultrices vitae. Curabitur 
															...
															<div class="income-input-row">
																<ul class="row ul">
																	<li class="col-sm-6">
																		<input type="text" placeholder="Monthly Revenue" name="month3avgrevenue" id="month3avgrevenue" value="<?php echo $tempdata['month3avgrevenue']?>">
																	</li>
																	<li class="col-sm-6">
																		<input type="text" placeholder="Monthly Profit" name="month3avgprofit" id="month3avgprofit" value="<?php echo $tempdata['month3avgprofit']?>">
																	</li> 
																</ul>
															</div>
													</div>
												...
												<li class="col-md-4">
													<div class="box">
														<h2 class="subhead">Trailing 12 Months</h2>
														<!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum aliquam velit risus, at fermentum mi ultrices vitae. Curabitur 
															pellentesque suscipit arcu ut fermentum. </p>-->
															<div class="income-input-row">
																<ul class="row ul">
																	<li class="col-sm-6">
																		<input type="text" placeholder="Monthly Revenue" name="month12avgrevenue" id="month12avgrevenue" value="<?php echo $tempdata['month12avgrevenue']?>">
																	</li>
																	<li class="col-sm-6">
																		<input type="text" placeholder="Monthly Profit" name="month12avgprofit" id="month12avgprofit" value="<?php echo $tempdata['month12avgprofit']?>">
																	</li> 
																</ul>
															</div>
													</div>
												...
												<li class="col-md-4">
													<div class="box">
														<h2 class="subhead">Average Monthly Customers</h2>
														
															<div class="income-input-row">
																<ul class="row ul">
																	<li class="col-sm-12">
																		<input type="text" placeholder="Average Monthly Customers" name="month6avgrevenue" id="month6avgrevenue" value="<?php echo $tempdata['month6avgrevenue']?>">
																	</li> 
																</ul>
															</div>
													</div>
									...
									<div id='tab5' class='content'>
										<h2 class="blue-heading text-center"><!--To expedite our vetting process, please explain why your listing is a good fit for our marketplace-->To expedite our vetting process, please tell us more about your business.</h2>
											...
											<ul class="ul row"> 
												<li class="col-md-12">
													<div class="box">
														...
														<!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum aliquam velit risus, at fermentum mi ultrices vitae. Curabitur pellentesque suscipit arcu ut fermentum. </p>-->
														<h2 class="subhead">Before you submit your application, please tell us more about your business model. Be sure to tell us anything else that we may need to know to better understand the value & health of your online business.</h2>
