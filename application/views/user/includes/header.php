...
<head>
	...
	<?php echo inline_code('style', 'animate', base_url() . 'assets/frontend/css/animate.min.css?v='.time()); ?>
	<?php echo inline_code('style', 'aos', base_url() . 'assets/frontend/css/aos.css?v='.time()); ?>
	<?php echo inline_code('style', 'owl.carousel', base_url() . 'assets/frontend/css/owl.carousel.min.css?v='.time()); ?>
	<?php echo inline_code('style', 'plugins', base_url() . 'assets/frontend/css/plugins.css?v='.time()); ?>
	<?php echo inline_code('style', 'style', base_url() . 'assets/frontend/css/style.min.css?v='.time()); ?>
	<?php echo inline_code('style', 'responsive', base_url() . 'assets/frontend/css/responsive.min.css?v='.time()); ?>
	<?php echo inline_code('style', 'dropzone', base_url() . 'assets/frontend/css/dropzone.min.css?v='.time()); ?>	
			...
			<div class="hbottom">
				<div class="container">
					<div class="d-flex align-items-center flex-wrap justify-content-between">
						...
						<div class="btn-group">
							<a href="<?php echo base_url();?>user/seller/getfreevaluation" class="btn blue-btn">Get Appraised</a>
