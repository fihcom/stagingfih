      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="header_box version_2">
            ...
            <a style="float:right;" class="btn btn-primary btn-sm addasset" href="<?php echo base_url(); ?>administrator/pending-faqs">Back to list</a>
          </div><!-- /.box-header -->
          <!-- form start -->
          <?php 
            ...
            <div class="box-footer">
              ...
              <input type="button" name="button" class="btn btn-danger" value="Reject" onclick="rejectrecord(this)" datadeletehref="<?php echo base_url()?>administrator/faq/reject/<?php echo $result->id;?>" />
            </div>
