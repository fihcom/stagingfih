<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">List Acquisition Get Fund List</li>
      </ol>
      <?php 
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> List Acquisition Get Fund List
          
        </div>
          
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="getfunded" width="100%" cellspacing="0">
            <thead>
            <tr>
                <th>ID</th>
                <th>Type</th>
                <th>Amount</th>
                <th>Fund needed in</th>
                <th>Website</th>
                <th>Phone</th>
                <th>Email</th>
