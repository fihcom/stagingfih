<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Fund Proofs</li>
    </ol>
    <?php 
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-bordered" id="fundprooftable" width="100%" cellspacing="0" data-count="">
          <thead>
            <tr>
              ...
              <th class="no-sort">Fund Status</th>
