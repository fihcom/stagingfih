      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="header_box version_2">
            <h2><i class="fa fa-file"></i>Add Sub Admin</h2>
          ...
          <?php 
            ...
            <form role="form" id="subadminaddfrm" action="<?php echo base_url(); ?>administrator/sub-admin/alter" method="post" role="form">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
            <input type="hidden" name="subadminId" id="subadminId" value="<?php echo $dataval['userId']?>">
            <div class="row">
                <div class="col-md-4">                                
                ...
                <div class="col-md-12">                                
                  <div class="form-group">
                      ...
                      <div class="row">
                          <div class="col-md-4"><span><input type="checkbox" name="authorize[user]" value="USER" id="user" class="permissionsettings" section="user" <?php echo array_key_exists("USER",$newAuthArr) ? 'checked':''?>>User </span></div>
                          <div class="col-md-8"><span><input type="checkbox" name="subauthorize[user][edit]" id="user_edit" value="EDIT" <?php echo in_array("EDIT",$newAuthArr['USER']) ? 'checked':''?>>Edit </span><span><input type="checkbox" name="subauthorize[user][delete]" value="DELETE" <?php echo in_array("DELETE",$newAuthArr['USER']) ? 'checked':''?> id="user_delete">Delete </span></div>
                          ...
                          <div class="col-md-8"><span><input type="checkbox" name="subauthorize[identityproof][edit]" id="identityproof_edit" value="EDIT" <?php echo in_array("EDIT",$newAuthArr['IDENTITYPROOF']) ? 'checked':''?>>Edit </span><span><input type="checkbox" name="subauthorize[identityproof][delete]" value="DELETE" <?php echo in_array("DELETE",$newAuthArr['IDENTITYPROOF']) ? 'checked':''?> id="identityproof_delete">Delete </span></div>
                          ...
                          <div class="col-md-8"><span><input type="checkbox" name="subauthorize[fundproof][edit]" id="fundproof_edit" value="EDIT" <?php echo in_array("EDIT",$newAuthArr['FUNDPROOF']) ? 'checked':''?>>Edit </span>
                          </div>
                      </div>
                ...
                <div class="col-md-12">                                
                  <div class="form-group">
                      ...
                      <div class="row">
                          <div class="col-md-4"><span><input type="checkbox" name="authorize[businessapplication]" value="BUSINESSAPPLICAITON" id="user" class="permissionsettings" section="businessapplication" <?php echo array_key_exists("BUSINESSAPPLICAITON",$newAuthArr) ? 'checked':''?>>Business Application </span></div>
                          <div class="col-md-8"><span><input type="checkbox" name="subauthorize[businessapplication][approve]" id="businessapplication_approve" value="APPROVE" <?php echo in_array("APPROVE",$newAuthArr['BUSINESSAPPLICAITON']) ? 'checked':''?>>Approve </span><span><input type="checkbox" name="subauthorize[businessapplication][edit]" id="businessapplication_edit" value="EDIT" <?php echo in_array("EDIT",$newAuthArr['BUSINESSAPPLICAITON']) ? 'checked':''?>>Edit </span><span><input type="checkbox" name="subauthorize[businessapplication][delete]" value="DELETE" <?php echo in_array("DELETE",$newAuthArr['BUSINESSAPPLICAITON']) ? 'checked':''?> id="businessapplication_delete">Delete </span></div>
                          ...
                          <div class="col-md-8"><span><input type="checkbox" name="subauthorize[faq][edit]" id="faq_edit" value="EDIT" <?php echo in_array("EDIT",$newAuthArr['FAQ']) ? 'checked':''?>>Edit </span><span><input type="checkbox" name="subauthorize[faq][delete]" value="DELETE" <?php echo in_array("DELETE",$newAuthArr['FAQ']) ? 'checked':''?> id="faq_delete">Delete </span></div>
                ...
                <div class="col-md-12">                                
                  <div class="form-group">
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-12 mb-2">
                            <div class="row">
                                <div class="col-md-4"><span><input type="checkbox" name="authorize[valuationapplication]" value="VALUATIONAPPLICATION" id="user" class="permissionsettings" section="valuationapplication" <?php echo array_key_exists("VALUATIONAPPLICATION",$newAuthArr) ? 'checked':''?>>Valuation Application </span></div>
                                <div class="col-md-8">
                                  <span class="mr-2"></div>
                            </div>
                          </div>
                ...
                <div class="col-md-12">                                
                  <div class="form-group">
                      <label for="cat_name">Acquisition Lending</label>
                      <div class="row">
                          <div class="col-sm-12 mb-2">
                            <div class="row">
                                <div class="col-md-4"><span><input type="checkbox" name="authorize[acquisitionlending]" value="ACQUISITIONLENDING" id="acquisitionlending" class="permissionsettings" section="acquisitionlending" <?php echo array_key_exists("ACQUISITIONLENDING",$newAuthArr) ? 'checked':''?>>Acquisition Lending </span></div>
                                <div class="col-md-8"><span class="mr-2">
                                  <input type="checkbox" name="subauthorize[acquisitionlending][add]" id="acquisitionlending_add" value="ADD" <?php echo in_array("ADD",$newAuthArr['ACQUISITIONLENDING']) ? 'checked':''?>>Add </span>
                                  <span class="mr-2"><input type="checkbox" name="subauthorize[acquisitionlending][edit]" id="acquisitionlending_edit" value="EDIT" <?php echo in_array("EDIT",$newAuthArr['ACQUISITIONLENDING']) ? 'checked':''?>>Edit </span>
                                  <span><input type="checkbox" name="subauthorize[acquisitionlending][delete]" value="DELETE" <?php echo in_array("DELETE",$newAuthArr['ACQUISITIONLENDING']) ? 'checked':''?> id="acquisitionlending_delete">Delete </span></div>
                            </div>
                          </div>
                          <div class="col-sm-12 mb-2">
                            <div class="row">
                                <div class="col-md-4"><span><input type="checkbox" name="authorize[acquisitionlendingcontent]" value="ACQUISITIONLENDINGCONTENT" id="acquisitionlendingcontent" class="permissionsettings" section="acquisitionlendingcontent" <?php echo array_key_exists("ACQUISITIONLENDINGCONTENT",$newAuthArr) ? 'checked':''?>>Acquisition Lending Content </span></div>
                                <div class="col-md-8">
                                  <span class="mr-2"><input type="checkbox" name="subauthorize[acquisitionlendingcontent][edit]" id="acquisitionlendingcontent_edit" value="EDIT" <?php echo in_array("EDIT",$newAuthArr['ACQUISITIONLENDINGCONTENT']) ? 'checked':''?>>Edit </span>
                                 </div> 
                            </div>
                          </div>
                          ...
                          <div class="col-sm-12 mb-2">
                            <div class="row">
                                <div class="col-md-4"><span><input type="checkbox" name="authorize[getfundlist]" value="GETFUNDLIST" id="getfundlist" class="permissionsettings" section="getfundlist" <?php echo array_key_exists("GETFUNDLIST",$newAuthArr) ? 'checked':''?>>Get Funded List </span></div>
                                <div class="col-md-8"><span class="mr-2"><input type="checkbox" name="subauthorize[getfundlist][delete]" value="DELETE" <?php echo in_array("DELETE",$newAuthArr['GETFUNDLIST']) ? 'checked':''?> id="getfundlist_delete">Delete </span></div>
                            </div>
                          </div>

                          <div class="col-sm-12 mb-2">
                            <div class="row">
                                <div class="col-md-4"><span><input type="checkbox" name="authorize[fundacquisitionlist]" value="FUNDACQUISITIONLIST" id="fundacquisitionlist" class="permissionsettings" section="fundacquisitionlist" <?php echo array_key_exists("FUNDACQUISITIONLIST",$newAuthArr) ? 'checked':''?>>Fund Acquisition List </span></div>
                                <div class="col-md-8"><span class="mr-2"><input type="checkbox" name="subauthorize[fundacquisitionlist][delete]" value="DELETE" <?php echo in_array("DELETE",$newAuthArr['FUNDACQUISITIONLIST']) ? 'checked':''?> id="fundacquisitionlist_delete">Delete </span></div>
                            </div>
                          </div>
                          <div class="col-sm-12 mb-2">
                            <div class="row">
                                <div class="col-md-4"><span><input type="checkbox" name="authorize[requestaccesslist]" value="REQUESTACCESSLIST" id="requestaccesslist" class="permissionsettings" section="requestaccesslist" <?php echo array_key_exists("REQUESTACCESSLIST",$newAuthArr) ? 'checked':''?>>REQUEST ACCESS List </span></div>
                                <div class="col-md-8"><span class="mr-2"><input type="checkbox" name="subauthorize[requestaccesslist][delete]" value="DELETE" <?php echo in_array("DELETE",$newAuthArr['REQUESTACCESSLIST']) ? 'checked':''?> id="requestaccesslist_delete">Delete </span></div>
                            </div>
                          </div>
                      </div>
