      ...
      <div id="accordion">
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
              <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">   
                        <div class="form-group">
                          <label for="cat_name">Cashflow Volatility</label>
                    ...
                    <div class="col-md-6">   
                            <div class="form-group">
                              <label for="cat_name">Yield</label>
                                <input type="text" class="form-control" name="multiple" id="multiple" placeholder="Yield" value="<?php echo $storedData->multiple?>">
                            </div>
                    </div>
                    <div class="col-md-6">   
                            <div class="form-group">
        ...
        <div class="box_general padding_bottom site-setting-area card"> 
            <div class="header_box version_2 collapsHeading collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
              <h2><i class="fa fa-file"></i>Listing Summery</h2>
            </div><!-- /.box-header -->
            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-12">   
                        <div class="form-group">
                          <label for="cat_name">Summery</label>
                          <textarea class="form-control editor" name="listingSummery" id="listingSummery"><?php echo $storedData->summery?></textarea>
                        </div>
                      </div> 
                    </div>   
                    <div class="row">
          ...
          <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion">
            <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">                                
                      <div class="form-group labelWrap">
                          <textarea name="reason_for_sale"  class="editor" style="width:100%" rows="5"><?php echo $storedData->reason_for_sale?></textarea>
                      </div>
                  </div>
                  <div class="col-md-12"> 
                    <div class="header_box version_2">
                  ...
                  <div class="col-md-12">                                
                      <div class="form-group labelWrap">
                          <textarea name="support_seller_included"  class="editor" style="width:100%" rows="5"><?php echo $storedData->support_seller_included?></textarea>
                      </div>
                  </div>
                  <div class="col-md-12"> 
                    <div class="header_box version_2">
                  ...
                  <div class="col-md-12">
                      <div class="form-group labelWrap">
                        ...
                        <textarea name="other_info_description" class="editor"  style="width:100%" rows="5"><?php echo $storedData->other_info_description?></textarea>
                      </div> 
                  </div>
                  <div class="col-md-12">                                
                      <div class="form-group labelWrap">
                  ...
                  <div class="col-md-12">
                    <div class="form-group labelWrap">
                      <label style="margin: 7px 0 0 8px;">Description</label>
                        <textarea name="buyer_profile_description" class="editor"  style="width:100%" rows="5"><?php echo $storedData->buyer_profile_description?></textarea>
                    </div> 
                  </div>
                  <div class="col-md-12">                                
                      <div class="form-group labelWrap">
                  ...
                  <div class="col-md-12">
                      <div class="form-group labelWrap">
                        <label style="margin: 7px 0 0 8px;">Description</label>
                                  <textarea name="skill_description" class="editor"  style="width:100%" rows="3"><?php echo $storedData->skill_description?></textarea>
                      </div>
                  </div>
                  <div class="col-md-12">                                
                          <div class="form-group labelWrap">
            ...
            <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12"> 
                      <?php
                      if($storedData->earnings !='')
                      {
                        $earning = json_decode($storedData->earnings);
                      }
                      ?>
                      ...
                      <div class="row" id="">
                        <div class="col-md-4">
                              ...
                              <div class="row">
                                            <div class="col-md-6">                                
                                              <div class="form-group">
                                                <label for="firstName">Calendar Year</label>
                                                <select name="earningcalendarYear[0]" id="" class="form-control">
                                                <option value="">Calendar Year</option>
                                                <?php
                                                  for($i = date('Y');$i>=(date('Y')-10);$i--)
                                                  {
                                                    ?>
                                                    <option value="<?php echo $i;?>" <?php echo ($i == $earning[0]->year)? 'selected':'';?>><?php echo $i;?></option>
                                                    <?php
                                                  }
                                                  ?>
                                              ...
                                              <div class="col-md-6">                                
                                                <div class="form-group">
                                                  ...
                                                  <select name="earningStatus[0]" id="" class="form-control">
                                                    <option value="1" <?php echo ($earning[0]->status == 1)? 'selected':'';?>>Active</option>
                                                    <option value="0" <?php echo ($earning[0]->status == 0)? 'selected':'';?>>Inactive</option>
                                                  </select>
                                                </div>
                                              </div>
                                              <?php
                                              ...
                                              foreach($Months as $k=>$v)
                                              {
                                                ?>
                                                <div class="col-md-12">                                
                                                  <div class="earning-month">
                                                    <label for="firstName"><?php echo $v?></label>
                                                  </div>
                                                </div>
                                                <div class="col-md-6">                                
                                                  <div class="form-group">
                                                  <input type="text" class="form-control" id="avgRevenue" name="avgRevenue[0][]" placeholder="Total Revenue" value="<?php echo $earning[0]->avgRevenue[$k]?>">
                                                  </div>
                                                </div>
                                                <div class="col-md-6">                                
                                                  <div class="form-group">
                                                    <input type="text" class="form-control" id="avgProfit" name="avgProfit[0][]" placeholder="Total Profit" value="<?php echo $earning[0]->avgProfit[$k]?>">
                                                  </div>
                                                </div>
                                                <?php
                                              }
                          ...
                          <!---->
                            <div class="row">
                                            <div class="col-md-6">                                
                                              <div class="form-group">
                                                <label for="firstName">Calendar Year</label>
                                                <select name="earningcalendarYear[1]" id="" class="form-control">
                                                <option value="">Calendar Year</option>
                                                <?php
                                                  for($i = date('Y');$i>=(date('Y')-10);$i--)
                                                  {
                                                    ?>
                                                    <option value="<?php echo $i;?>" <?php echo ($i == $earning[1]->year)? 'selected':'';?>><?php echo $i;?></option>
                                                    <?php
                                                  }
                                                  ?>
                                              ...
                                              <div class="col-md-6">                                
                                                <div class="form-group">
                                                  <label for="firstName">Status</label>
                                                  <select name="earningStatus[1]" id="" class="form-control">
                                                    <option value="1" <?php echo ($earning[1]->status == 1)? 'selected':'';?>>Active</option>
                                                    <option value="0" <?php echo ($earning[1]->status == 0)? 'selected':'';?>>Inactive</option>
                                                  </select>
                                                </div>
                                              </div>
                                              <?php
                                              ...
                                              foreach($Months as $k=>$v)
                                              {
                                                ...
                                                <div class="col-md-6">                                
                                                  <div class="form-group">
                                                  <input type="text" class="form-control" id="avgRevenue" name="avgRevenue[1][]" placeholder="Total Revenue" value="<?php echo $earning[1]->avgRevenue[$k]?>">
                                                  </div>
                                                </div>
                                                <div class="col-md-6">                                
                                                  <div class="form-group">
                                                    <input type="text" class="form-control" id="avgProfit" name="avgProfit[1][]" placeholder="Total Profit" value="<?php echo $earning[1]->avgProfit[$k]?>">
                                                  </div>
                                                </div>
                                                <?php
                                              }
                            ...
                            <!---->
                              <div class="row">
                                              <div class="col-md-6">                                
                                                <div class="form-group">
                                                  <label for="firstName">Calendar Year</label>
                                                  <select name="earningcalendarYear[2]" id="" class="form-control">
                                                  <option value="">Calendar Year</option>
                                                  <?php
                                                    for($i = date('Y');$i>=(date('Y')-10);$i--)
                                                    {
                                                      ?>
                                                      <option value="<?php echo $i;?>" <?php echo ($i == $earning[2]->year)? 'selected':'';?>><?php echo $i;?></option>
                                                      <?php
                                                    }
                                                    ?>
                                                ...
                                                <div class="col-md-6">                                
                                                  <div class="form-group">
                                                    <label for="firstName">Status</label>
                                                    <select name="earningStatus[2]" id="" class="form-control">
                                                      <option value="1" <?php echo ($earning[2]->status == 1)? 'selected':'';?>>Active</option>
                                                      <option value="0" <?php echo ($earning[2]->status == 0)? 'selected':'';?>>Inactive</option>
                                                    </select>
                                                  </div>
                                                </div>
                                                <?php
                                                ...
                                                foreach($Months as $k=>$v)
                                                {
                                                  ...
                                                  <div class="col-md-6">                                
                                                    <div class="form-group">
                                                    <input type="text" class="form-control" id="avgRevenue" name="avgRevenue[2][]" placeholder="Total Revenue" value="<?php echo $earning[2]->avgRevenue[$k]?>">
                                                    </div>
                                                  </div>
                                                  <div class="col-md-6">                                
                                                    <div class="form-group">
                                                      <input type="text" class="form-control" id="avgProfit" name="avgProfit[2][]" placeholder="Total Profit" value="<?php echo $earning[2]->avgProfit[$k]?>">
                                                    </div>
                                                  </div>
                                                  <?php
                                                }
                  ...
                  <div class="col-md-12"> 
                    <?php
                                if($storedData->traffic !='')
                                {
                                  $traffic = json_decode($storedData->traffic);
                                }
                                ?>
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="row">
                                  <div class="col-md-6">                                
                                    <div class="form-group">
                                      <label for="firstName">Calendar Year</label>
                                      <select name="calendarYear[0]" id="" class="form-control">
                                      <option value="">Calendar Year</option>
                                      <?php
                                        for($i = date('Y');$i>=(date('Y')-10);$i--)
                                        {
                                          ?>
                                          <option value="<?php echo $i;?>" <?php echo ($i == $traffic[0]->year)? 'selected':'';?>><?php echo $i;?></option>
                                          <?php
                                        }
                                        ?>
                                  ...
                                  <div class="col-md-6">                                
                                    <div class="form-group">
                                      <label for="firstName">Status</label>
                                      <select name="trafficStatus[0]" id="" class="form-control">
                                        <option value="1" <?php echo ($traffic[0]->status == 1)? 'selected':'';?>>Active</option>
                                        <option value="0" <?php echo ($traffic[0]->status == 0)? 'selected':'';?>>Inactive</option>
                                      </select>
                                    </div>
                                  </div>
                                    <?php
                                    ...
                                    foreach($Months as $k=>$v)
                                    {
                                      ...
                                      <div class="col-md-6">                                
                                        <div class="form-group">
                                        <input type="text" class="form-control" id="avgRevenue" name="totalPageView[0][]" placeholder="Total Page view" value="<?php echo $traffic[0]->avgPageview[$k]?>">
                                        </div>
                                      </div>
                                      <div class="col-md-6">                                
                                        <div class="form-group">
                                          <input type="text" class="form-control" id="avgProfit" name="totalVisitor[0][]" placeholder="Total Visitor" value="<?php echo $traffic[0]->avgVisitor[$k]?>">
                                        </div>
                                      </div>
                                      <?php
                                    }
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="row">
                                    <div class="col-md-6">                                
                                      <div class="form-group">
                                        <label for="firstName">Calendar Year</label>
                                        <select name="calendarYear[1]" id="" class="form-control">
                                        <option value="">Calendar Year</option>
                                        <?php
                                          for($i = date('Y');$i>=(date('Y')-10);$i--)
                                          {
                                            ?>
                                            <option value="<?php echo $i;?>" <?php echo ($i == $traffic[1]->year)? 'selected':'';?>><?php echo $i;?></option>
                                            <?php
                                          }
                                          ?>
                                      ...
                                      <div class="col-md-6">                                
                                        <div class="form-group">
                                          <label for="firstName">Status</label>
                                          <select name="trafficStatus[1]" id="" class="form-control">
                                            <option value="1" <?php echo ($traffic[1]->status == 1)? 'selected':'';?>>Active</option>
                                            <option value="0" <?php echo ($traffic[1]->status == 0)? 'selected':'';?>>Inactive</option>
                                          </select>
                                        </div>
                                      </div>
                                      <?php
                                      ...
                                      foreach($Months as $k=>$v)
                                      {
                                        ...
                                        <div class="col-md-6">                                
                                          <div class="form-group">
                                          <input type="text" class="form-control" id="avgRevenue" name="totalPageView[1][]" placeholder="Total Page view" value="<?php echo $traffic[1]->avgPageview[$k]?>">
                                          </div>
                                        </div>
                                        <div class="col-md-6">                                
                                          <div class="form-group">
                                            <input type="text" class="form-control" id="avgProfit" name="totalVisitor[1][]" placeholder="Total Visitor" value="<?php echo $traffic[1]->avgVisitor[$k]?>">
                                          </div>
                                        </div>
                                        <?php
                                      }
