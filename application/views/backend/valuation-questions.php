  ...
  <!-- Example DataTables Card-->
    <div class="card mb-3">
      <div class="card-header">
        ...
        <a style="float:right;" class="btn btn-primary btn-sm" href="<?php echo base_url() ?>administrator/valuation_questions/add"><i class="fa fa-plus"></i> Add Valuation Questions </a>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-bordered dragtablevaluationquestion" id="" width="100%" cellspacing="0" data-count="">
          <thead>
            <tr>
              <th>Sl No.</th>
              <th>Factor</th>
          ...
          if(is_array($result) && count($result)>0)
          {
            ...
            <td><?php echo $i;?></td>
            <td><?php echo $valuationFactors[$val['factor']]?></td>
            <td><?php echo $val['question']?></td>
            <td><?php echo $val['low_range'].'-'.$val['high_range'];?></td>
            <td><?php echo $val['worth']?></td>
            <td><a href="<?php echo base_url()?>administrator/valuation_questions/edit/<?php echo $val['id'];?>" class="btn-sm btn-primary editrec"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;<a href="javascript: void(0)" onclick="deleterecord(this)" datadeletehref="<?php echo base_url()?>administrator/valuation_questions/delete/<?php echo $val['id'];?>" class="btn-sm btn-danger deleterec"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
            </tr>
            <?php
            $i++;
            }
