...
<html>
  <head>
    <meta charset="UTF-8">
    <title>FIH.com | Admin System Log in</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#">FIH.com<br>Admin System</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url() ?>userregistration/loginUser" method="post">
        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
          <input type="hidden" name="subscription" id="subscription" value="<?php if(isset($subscription) && $subscription!='') { echo $subscription; } ?>">
