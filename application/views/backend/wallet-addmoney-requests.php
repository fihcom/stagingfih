<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Wallet Topup/Withdraw Requests</li>
    </ol>
    <?php 
      ...
      <div class="row">
          ...
          <div class="col-md-9">                                
             <div class="form-group form-inline float-right"><label for="searchName">Search: &nbsp;</label>
                <input type="text" class="form-control" value="" id="AddmoneysearchName" name="AddmoneysearchName"> &nbsp;<label for="offerStatus">Buy Request Status: &nbsp;</label>
                <select class="mdb-select colorful-select dropdown-primary form-control" searchable="Search here.." name="AddmoneyStatus" id="AddmoneyStatus">
        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="listingwalletaddmoneyTable" width="100%" cellspacing="0" data-count="">
          <thead>
            <tr>
              <th>Buyer Name</th>
              <th>Email</th>
