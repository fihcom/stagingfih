<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Pending FAQs</li>
    </ol>
    <?php 
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-bordered" id="faqTable" width="100%" cellspacing="0" data-count="">
          <thead>
            <tr>
              <th>Listing#</th>
              <th>Buyer Name</th>
              ...
              <th>Reply Date</th>
              <th>Reply</th>
              <th class="no-sort">Admin Status</th>
