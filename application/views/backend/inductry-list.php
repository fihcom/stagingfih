  ...
  <!-- Example DataTables Card-->
    <div class="card mb-3">
      <div class="card-header">
        ...
        {
          ?>
        <a style="float:right;" class="btn btn-primary btn-sm addasset" href="javascript: void(0);"><i class="fa fa-plus"></i> Add New Industry </a>
        <?php
        }
        ?>
      </div>
      ...
      <div class="box box-primary addassetpane" style="display:none">
            ...
            <form role="form" id="AddAsset" action="<?php echo base_url(); ?>administrator/site-settings/industries/add" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">                                
                    <div class="form-group">
                      ...
                      <select name="industryStatus" id="" class="form-control">
        ...
        <div class="table-responsive">
          <table class="table table-bordered <?php echo ($editpermission)? 'gallerydragtable':'';?>" id="galleryTable" width="100%" cellspacing="0" data-count="<?php echo $countAllBookings;?>">
          <thead>
            <tr>
              <th>Sl No.</th>
              <th>Industry</th>
          ...
          if(is_array($assets) && count($assets)>0){
            ...
            foreach($assets as $val){
              ...
              ?>
              <form action="<?php echo base_url(); ?>administrator/site-settings/industries/add" method="post">
              ...
              <td><?php echo $i;?></td>
              <td><input type="text" class="form-control" id="Industry" name="Industry" value="<?php echo $val['industry'];?>"></td>
              ...
              {
              ?>
              <?php echo '<a href="javascript: void(0)" onclick="deleterecord(this)" datadeletehref="'.base_url().'administrator/site-settings/industries/delete/'.$val['id'].'" class="btn-sm btn-danger deletepolitician"><i class="fa fa-trash" aria-hidden="true"></i></a>';?>
              <?php
              }
              ?>
              </td>
            ...
            ?>
            <tr>
            <td colspan="5">No Industry Found.</td>
            </tr>
            <?php
          }
          ?>
