<div class="content-wrapper">
  <div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Listing Offer Details</li>
      </ol>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="header_box version_2">
            <h2><i class="fa fa-file"></i>Listing Offer Details</h2>
            <a style="float:right;" class="btn btn-primary btn-sm addasset" href="<?php echo base_url(); ?>administrator/listing-offers">Back to list</a>
          </div><!-- /.box-header -->
          <!-- form start -->
