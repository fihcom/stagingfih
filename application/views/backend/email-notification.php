<div class="content-wrapper">
  <div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Email/Notification Contents</li>
      </ol>
            ...
            <div class="row">
             ...
             <div class="col-md-9">                                
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo ($result[0]['author']!='')?$result[0]['author']:'' ?>" id="" name="author">
                  </div>
                </div> 
                <div class="col-md-3">                                
                <div class="form-group">
                      <label for="cat_name">Designation</label>
                      <input type="text" class="form-control" value="<?php echo $result[0]['designation'] ?>" id="site_title" name="desingation">
                  </div>
                </div>             
            </div>
