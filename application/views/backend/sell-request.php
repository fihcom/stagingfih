      ...
      <div class="row">
          ...
          <div class="col-md-6">                                
             <div class="form-group form-inline float-right"><label for="searchName">Search: &nbsp;</label>
                <input type="text" class="form-control" value="" id="searchNameSellReq" name="searchName"> &nbsp;<label for="offerStatus">Sell Status: &nbsp;</label>
                <select class="mdb-select colorful-select dropdown-primary form-control" searchable="Search here.." name="sellStatus" id="sellStatusSellReq">
        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="adminsellbusinessTable" width="100%" cellspacing="0">
          <thead>
            <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="deleteModalLabel">Are you sure want to reject this sell business request?</h4>
