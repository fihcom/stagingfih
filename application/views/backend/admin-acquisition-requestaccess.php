<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Request Access List</li>
      </ol>
      <?php 
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Request Access List
          
        </div>
          
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="requestaccess" width="100%" cellspacing="0">
            <thead>
            <tr>
                <th>ID</th>
                <th>investor</th>
