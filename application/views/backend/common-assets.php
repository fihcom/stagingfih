<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Common Assets</li>
    </ol>
    <?php 
  ...
  <!-- Example DataTables Card-->
    <div class="card mb-3">
      <div class="card-header">
        ...
        {
          ?>
          <a style="float:right;" class="btn btn-primary btn-sm addasset" href="javascript: void(0);"><i class="fa fa-plus"></i> Add New Asset </a>
          <?php
        }
        ?>
      ...
      <div class="box box-primary addassetpane" style="display:none">
            ...
            <form role="form" id="AddAsset" action="<?php echo base_url(); ?>administrator/site-settings/common-list-assets/add" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-md-6">                                
                    <div class="form-group">
                      <label for="firstName">Asset Description<span style="color:red;">*</span></label>
                      <input type="text" class="form-control" id="AssetDescription" name="AssetDescription" value="">
                    </div>
                  </div>
                  <div class="col-md-6">                                
                    <div class="form-group">
        ...
        <div class="table-responsive">
          ...
          if(is_array($assets) && count($assets)>0){
            ...
            foreach($assets as $val){
              ...
              <td><?php echo $i;?></td>
              <td><input type="text" class="form-control" id="AssetDescription" name="AssetDescription" value="<?php echo $val['asset_description'];?>"></td>
              ...
              <?php echo '<a href="javascript: void(0)" onclick="deleterecord(this)" datadeletehref="'.base_url().'administrator/site-settings/common-list-assets/delete/'.$val['id'].'" class="btn-sm btn-danger deletepolitician"><i class="fa fa-trash" aria-hidden="true"></i></a>';?>
              <?php
              }
              ?>
              </td>
