  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      ?>
        ...
        if(checkAuthorization('BUSINESSAPPLICATION','LIST') || checkAuthorization('VALUATIONAPPLICATION','LIST') || checkAuthorization('LISTING','LIST') || checkAuthorization('PROMOCODE','LIST') || checkAuthorization('FAQ','LIST') || checkAuthorization('LISTINGOFFERS','LIST'))
        {
        ?>
...
<li class="nav-item<?php if(isset($class) && $class=='sellrequest') { echo ' active'; }?>" data-toggle="tooltip" data-placement="right" title="Listing Mnaagement">
        ...
        <ul class="sidenav-second-level collapse <?php if(isset($class) && $class=='sellrequest') { echo 'show'; }?>" id="collapseListing">
          ...
          if(checkAuthorization('VALUATIONAPPLICATION','LIST'))
          {
            ?>
          <li>
      ...
      <?php
        ...
        if(checkAuthorization('ACQUISITIONLENDING','LIST') || 
        checkAuthorization('ACQUISITIONLENDINGCONTENT','EDIT') || 
        checkAuthorization('GETFUNDLIST','LIST') || 
        checkAuthorization('FUNDACQUISITIONLIST','LIST') || 
        checkAuthorization('REQUESTACCESSLIST','LIST'))
        {
          ?>
        <li class="nav-item<?php if(isset($class) && $class=='acquisitionlending') { echo ' active'; }?>" data-toggle="tooltip" data-placement="right" title="Acquisition Lending">
        <a class="nav-link nav-link-collapse <?php if(isset($class) && $class=='acquisitionlending') { echo ''; } else { echo 'collapsed'; }?>" data-toggle="collapse" href="#collapseAcquisition" data-parent="#listingAcquisition" <?php if(isset($class) && $class=='sellrequest') { echo 'aria-expanded="true"'; } ?>>
          <i class="fa fa-list"></i>
          <span class="nav-link-text">Acquisition Lending</span>
        </a>
        <ul class="sidenav-second-level collapse <?php if(isset($class) && $class=='acquisitionlending') { echo 'show'; }?>" id="collapseAcquisition">
          ...
          if(checkAuthorization('ACQUISITIONLENDING','LIST'))
          {
            ?>
          <li>
          <a href="<?php echo base_url() ?>administrator/acquisition-lending-list">
            <span class="nav-link-text">Acquisition Lending List</span>
          </a>
        </li>
          <?php
          }
          if(checkAuthorization('ACQUISITIONLENDINGCONTENT','EDIT'))
          {
            ?>
          <li>
          <a href="<?php echo base_url() ?>administrator/acquisition-lending/contents">
            <span class="nav-link-text">Acquisition Lending Contents</span>
          </a>
          </li>
        <?php
        }
          if(checkAuthorization('GETFUNDLIST','LIST'))
          {
            ?>
          <li>
          <a href="<?php echo base_url() ?>administrator/acquisition-getfund-list">
            <span class="nav-link-text">Acquisition Get Fund List</span>
          </a>
          </li>
        <?php
        }
          if(checkAuthorization('FUNDACQUISITIONLIST','LIST'))
          {
            ?>
          <li>
          <a href="<?php echo base_url() ?>administrator/acquisition-businessacquisition-list">
            <span class="nav-link-text">Fund Acquisition List</span>
          </a>
          </li>
        <?php
        }
        
          if(checkAuthorization('REQUESTACCESSLIST','LIST'))
          {
            ?>
          <li>
          <a href="<?php echo base_url() ?>administrator/acquisition-requestaccess-list">
            <span class="nav-link-text">Request access List</span>
          </a>
          </li>
        <?php
        }
      ...
      <?php
        ...
        <li class="nav-item<?php if(isset($class) && $class=='cms-management') { echo ' active'; }?>" data-toggle="tooltip" data-placement="right" title="Free downloaded contents">
          ...
          <li>
            <a href="<?php echo base_url(); ?>administrator/banners">Site Banner<span class="badge badge-pill badge-success"></span></a>
          </li>
          <?php
          }
          ...
          ?>
          <li>
            <a href="<?php echo base_url(); ?>administrator/nda-content">NDA Content of Listing<span class="badge badge-pill badge-success"></span></a>
          </li>
          <?php
