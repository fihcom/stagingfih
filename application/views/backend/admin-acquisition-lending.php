<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Acquisition Lending List</li>
      </ol>
      <?php 
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> List Acquisition Lending
          <?php
          if($addpermission)
          {
            ?>
            <a style="float:right;" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>administrator/add-acquisition"><i class="fa fa-plus"></i> Add New Acquisition</a>
            <?php
          }
          ?>
        </div>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="lendingTable" width="100%" cellspacing="0">
            <thead>
            <tr>
                <th>ID</th>
                <th>Industry</th>
