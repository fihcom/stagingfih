  ...
  <!-- Example DataTables Card-->
    <div class="card mb-3">
      <div class="card-header">
        ...
        <a style="float:right;" class="btn btn-primary btn-sm" href="<?php echo base_url().'administrator/sub-admin/add';?>"><i class="fa fa-plus"></i> Add New Admin </a>
      </div>
      <div class="card-body">
      
        <div class="table-responsive">
          <table class="table table-bordered" id="subadmintable" width="100%" cellspacing="0" data-count="">
          <thead>
            <tr>
