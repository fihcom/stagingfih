				...
				<div class="itemheader">
					<div class="bannerbox">
						<figure class="bannerimg">
							<img src="<?php echo base_url();?>uploads/banner_images/resized/<?php echo $banner['homeimage']?>" alt="banner">
						</figure>
						<div class="bannertext">
							<div class="container">
								<div class="banner_right_text">
								<?php $listPoints =  json_decode($banner['homelistcontents'],true);?>
								<ul>
									<?php
									if(trim($listPoints[0]) !='')
									{
										?>
										<li><?php echo $listPoints[0];?></li>
										<?php
									}if(trim($listPoints[1]) !='')
									{
										?>
										<li><?php echo $listPoints[1];?></li>
										<?php
									}if(trim($listPoints[2]) !='')
									{
										?>
										<li><?php echo $listPoints[2];?></li>
										<?php
									}if(trim($listPoints[3]) !='')
									{
										?>
										<li><?php echo $listPoints[3];?></li>
										<?php
									}
								...
								<div class="bannertext-in">
									<h1 class="heading">
										<!--The Verified  NYC'S CURATED --> <?php echo $banner['homeheading1']?>
									</h1>
								...
								<div class="search_section mt20 d-none">
									<form method="get" action="<?php echo base_url();?>marketplace">
										...
										<div class="row">
											...
											<div class="col-sm-3">
												<input type="submit" value="Search Listings" class="home_banner_submit_btn" />
											</div>
										</div>
									</form>
								</div>
