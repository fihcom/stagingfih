...
<head>
	...
	<?php //echo inline_code('style', 'dropzone', base_url() . 'assets/frontend/css/dropzone.min.css'); ?>
	<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/css/animate.min.css?v='.time(); ?>">
	<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/css/aos.css?v='.time(); ?>">
	<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/css/owl.carousel.min.css?v='.time(); ?>">
	<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/css/plugins.css?v='.time(); ?>">
	<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/css/style.min.css?v='.time(); ?>">
	<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/css/responsive.min.css?v='.time(); ?>">
	<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/css/price-range.min.css?v='.time(); ?>">
	<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/css/dropzone.min.css?v='.time(); ?>">
	<!-- Global site tag (gtag.js) - Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-203069569-1">
	</script>
	...
	<?php 
		if($this->session->userdata('fullname')){
			?>
	<script>
			var fullNameSign = '<?php echo $this->session->userdata('fullname'); ?>';
	</script>
			<?php
		}
	?>
			...
			<div class="innerbanner">
				<div class="bannerbox">
					<figure class="bannerimg">
						<img src="<?php echo base_url();?>uploads/banner_images/resized/<?php echo $banner['insideimage']?>" alt="banner">
					</figure>
					<div class="bannertext">
						<div class="container">
							<div class="bannertext-in">
								...
								if($nocaption){}else{
									?>
									<h2 class="subheading"><?php echo $banner['innertext1']?></h2>
									<p><?php echo $banner['innertext2']?></p>
						...
						{
							if($nocaption){
								$regButtonClass = 'regBtn';
							}
							?>
								<a href="<?php echo base_url();?>register" class="btn <?php echo $regButtonClass;?>">Register For Full Access </a>
								<?php
								}
								?>
							</div>
