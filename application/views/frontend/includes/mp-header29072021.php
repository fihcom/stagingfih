...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/frontend/css/price-range.css"> 
			...
			<div class="innerbanner"> 
				<div class="bannerbox"> 
					<figure class="bannerimg">
						<img src="<?php echo base_url();?>assets/frontend/images/sample/marketplace-banner.jpg" alt="banner">
					</figure> 
					<div class="bannertext"> 
						<div class="container">
							<div class="bannertext-in">  
								...
								if($nocaption){}else{
									?>
									<h2 class="subheading">Online Businesses For Sale</h2>
								<p>A curated marketplace of profitable listings from verified sellers.</p>
