<footer class="mainFooter">
			...
			<div class="container">
				<div class="row">
						...
						<div class="fbox">
							...
							<nav class="fnav">
								<ul class="in">
									...
									<li><a href="<?php echo base_url();?>marketplace"><span>View Exclusive Offerings</span></a></li><!-- Online Business Marketplace -->
					...
					<div class="col-md-5 fblock" data-aos="fade-left" data-aos-duration="2200">
						<div class="fbox">
							<h2 class="subheading">Buy-Side Newsletter</h2>
							<p>Sign up below and get notified weekly via email when new exclusive M&A offerings are listed or updated.</p>
	...
	<script type="text/javascript" src="<?php echo base_url();?>assets/frontend/js/jquery.validate.min.js?v=<?php echo time(); ?>"></script>
	...
	?>
		<script type="text/javascript" src="<?php echo base_url();?>assets/frontend/js/dropzone.min.js?v=<?php echo time(); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url();?>assets/frontend/js/listing-details.min.js?v=<?php echo time(); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url();?>assets/frontend/js/listing-details-updated.js?v=<?php echo time(); ?>"></script>
	<?php
	...
	?>
	<script type="text/javascript" src="<?php echo base_url();?>assets/frontend/js/marketplace.min.js?v=<?php echo time(); ?>"></script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data.data.listing, function( index, value ) {
                        ...
                        mpelement = mpelement.replace("[REVENUE_MULTIPLE]",value.revenue_multiple);
                        mpelement = mpelement.replace("[PRICE]", listingPrice.replace(/(.)(?=(\d{3})+$)/g,'$1,'));
