						 ...
						 <ul class="row ul">
                            ...
                            <li class="col-sm-12 term-cond">
								<div class="labelWrap">
									...
									<div class="term-text">
										By registering for an account on FIH.com, I understand and agree to their <a href="<?php echo base_url();?>links/terms-conditions" target="_blank" rel="noopener noreferrer" class="Link__StyledLink-ljrJwl hysMmG undefined link">Terms of Use</a> which contains important details about buying & selling online businesses.
									</div>
								</div>
                            </li> 
							<li class="col-sm-12">
