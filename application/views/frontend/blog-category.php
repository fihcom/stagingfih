                            ...
                            <div class="box">
                                <a href="<?php echo base_url();?>blog/<?php echo $v['blogSlug']?>" title="<?php echo $v['blogName']?>">
                                    ...
                                    <div class="text">
                                        ...
                                        {
                                            ?>
                                                <div class="admin">Post: by <?php echo $v['blog_author']?></div>
                                                <?php
                                        }
                                        ?>
                                        ...
                                        <div class="para">
                                        <?php echo substr(strip_tags($v['blogDescription']),0,200); ?>...
                                        </div>
                ...
                <li class="col-sm-6">
                    <div class="box">
                        <a href="<?php echo base_url();?>blog/[BLOGSLUG]" title="blogname">
                            ...
                            <div class="text">
                                <div class="admin" [blogdisplay]>Post: by [BLOGAUTHOR]</div>
