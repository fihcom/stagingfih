			...
			<div class="container">
				...
				<?php
					...
					<div class="marketplace-btn-wrap"> 
								...
								?>
								<a href="#request-financing" class="fancybox btn ml-auto rightalignedbtn" data-fancybox>Request Financing Details</a>
								...
								<form id="reqfinancingfrm" action="<?php echo base_url(); ?>listing/requestfinancingdetails" method="post">
									...
									<input type="hidden" name="listingNo" value="<?php echo $listing_id?>" /> 
									<h1>Request Financing Details</h1>
								...
								<a href="#become-ceo" class="fancybox btn ml-2 rightalignedbtn" data-fancybox>Become the CEO</a>
