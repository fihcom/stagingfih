<main class="mainContainer">  
		<section class="section login-sec register-sec create-ticket">
			...
			?>
			<div>
					<button class="btn blue-btn schedulecallbtn pull-right">Schedule Call</button>
						 ...
						 <ul class="row ul">
							...
							<li class="col-sm-4">
								<div class="labelWrap">
									...
									<!-- <input type="datetime-local" name="callScheduleTime" id="callScheduleTime" value="<?php echo $dataVal['callScheduleTime']?>"> -->
									<input type="text" name="callScheduleTime" id="callScheduleTime" value="<?php echo $dataVal['callScheduleTime']?>" readonly>
								</div>
                            </li>
							<li class="col-sm-12">
								<div class="labelWrap">
		...
		<div class="row pull-right search-status">
									...
									<div class="col-md-5">
										...
										<input type="text" class="form-control" name="textSearch" id="textSearch" value="<?php echo $result->sellername;?>" readonly>
									</div>
									<div class="col-md-3">
										<label>Status</label>
