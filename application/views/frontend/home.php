	...
	<section class="section latest-listing">
								...
								<div class="col-md-8">
									<a href="<?php echo base_url();?>listing/<?php echo $rb['listing_id'];?>" class="d-block">
										...
										<div class="starting-price">
											...
											<span class="multiple"><span><?php echo $rb['multiple'];?>x Profit Multiple</span></span>
											<span class="multiple yellowbaba"><span><?php echo $rb['revenue_multiple'];?>x Revenue Multiple</span></span>
										</div>
									</a>
								</div>
								<div class="col-md-2">
		...
		<section class="section whats-nbp">
			<div class="container">
				...
				<p class="small-desc text-center"><?php echo $homecontents[0]['content']?></p>
				<div class="nbp-list">
					<ul class="ul row">
		...
		<section class="section home-blog">
			<div class="container">
				 ...
				 <div class="short-desc text-center mb30">Want to know how to better run your online business?  Check out our new curated content (covering various niches).</div>
				<div class="blog_list">
					<ul class="ul row">
					<?php
						if(is_array($blogs) && count($blogs)>0)
								...
								<div class="box">
									...
									<div class="text">
										...
										<div class="bottom">
											...
											{
												?>
												<span class="admin">By  <?php echo ($v['blog_author'] !='')?$v['blog_author']:'Admin';?></span>
												<?php
											}
											?>
