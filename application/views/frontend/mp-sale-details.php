...
<main class="mainContainer">  
		...
		<div class="container">
			<div class="<?php //echo ($permission['isunlocked'] == TRUE && $business_image!='')?'marketplace-details-wrap-sec':'';?>">
				...
				<div class="marketplace-btn-wrap"> 
					...
					<div class="btn_group marketplace-btn marketplace-sold-btn">
						...
						<div class="sold">sold </div>
								...
								?>
					<div class="btn_group marketplace-btn d-flex flex-wrap text-left mt-3">
								<?php
						...
						<div id="buy-now-pane" class="buy-now-pane" style="display:none;">
							...
							<form id="submitbuyrequestfrm" action="<?php echo base_url(); ?>listing/submitbuyrequest" method="post">
								...
								?>
									<a id="seefulldetails" href="<?php echo $unlockLink;?>" class="<?php echo $class?> btn blue-btn btn_t ml-2 pgGreen" <?php echo $datafancybox;?>>Sign NDA to Uncover Listing</a>
								<?php
								}
							}
							?>
							<a href="#request-financing" class="fancybox btn rightalignedbtn" data-fancybox>Request Financing</a> <!-- ml-auto Request Financing Details -->
							<div id="request-financing" style="display:none; width:50%">
							<form id="reqfinancingfrm" action="<?php echo base_url(); ?>listing/requestfinancingdetails" method="post">
								...
								<div class="alert alert-success alert-dismissible successmessagefinancing" style="display:none;" role="alert">
									<strong>Success!</strong> 
									<ul>
											<li id="successmessagefinancing"></li>
									</ul>   
								</div>
								<div class="alert alert-danger alert-dismissible errormessagefinancing" style="display:none;" role="alert">
									<strong>Error!</strong> 
									<ul id="errormessagefinancing">
									</ul>   
								</div>
								<div>Here you can request to get funding to acquire the FIH.com business listed. Please submit the form below to get custom details about LTV, interest rate, term length, & other financing details.</div>
								<ul class="ul row">
								<li class="col-sm-12" style="padding-top: 15px; font-size: 20px;">
										Listing #<?php echo $listing_id?>
									</li>
									<li class="col-sm-12">
										<input type="email" name="Email" id="" placeholder="Email" value="">
									</li>
									<li class="col-sm-12">
										<input type="text" name="Phone" id="" placeholder="Phone" value="">
									</li>
									<li class="col-sm-12">
							...
							<a href="#become-ceo" class="fancybox btn ml-2 rightalignedbtn" data-fancybox>Become CEO</a> <!-- Become the CEO -->
							

							<div id="become-ceo" style="display:none; width:50%">
							<form id="becomeceofrm" action="<?php echo base_url(); ?>listing/becometheceo" method="post">
								<input type="hidden" class="csrftoken" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
								<input type="hidden" name="listingNo" value="<?php echo $listing_id?>" /> 
								<h1>Become CEO</h1>
								<div class="alert alert-success alert-dismissible successmessageceo" style="display:none;" role="alert">
									<strong>Success!</strong> 
									<ul>
											<li id="successmessageceo"></li>
									</ul>   
								</div>
								<div class="alert alert-danger alert-dismissible errormessageceo" style="display:none;" role="alert">
									<strong>Error!</strong> 
									<ul id="errormessageceo">
									</ul>   
								</div>
								<div>Here you can apply to run the company being listed for sale. In this, some business buyers (& some current owners) want to have someone on board to run the company for them as they themselves don't have the time. In this role, you have the opportunity to be an CEO with all the benefits that come with it. Once you fill out the form below, we will reach out with custom details about what this specific opportunity offers.</div>
								<ul class="ul row">
									<li class="col-sm-12" style="padding-top: 15px; font-size: 20px;">
										Listing #<?php echo $listing_id?>
									</li>
									...
									<li class="col-sm-12">
										<input type="text" name="LinkedInProfile" id="" placeholder="LinkedIn Profile" value="">
									</li>
									<li class="col-sm-12">
										<button type="submit" class="btn">Submit Application</button>
									</li>
								...
								<a href="#submit-lending-offer" class="fancybox btn ml-2 lendingoffer-btn" data-fancybox>Offer Financing</a>
								<div id="submit-lending-offer" style="display:none; max-width:760px; width:100%">
									<form id="lendingfrm" action="<?php echo base_url(); ?>listing/lendingoffer" method="post">
									<input type="hidden" class="csrftoken" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
									<input type="hidden" name="listingNo" value="<?php echo $listing_id?>" /> 
									<h1>Lend Money to an Accredited Acquirer to Buy this Successful Business</h1>
									<div class="alert alert-success alert-dismissible successmessagelending" style="display:none;" role="alert">
										<strong>Success!</strong> 
										<ul>
												<li id="successmessagelending"></li>
										</ul>   
									</div>
									<div class="alert alert-danger alert-dismissible errormessagelending" style="display:none;" role="alert">
										<strong>Error!</strong> 
										<ul id="errormessagelending">
										</ul>   
									</div>
									<div>Not interest to buy this business but still want to take a passive stake that could get you +/- 10% interest? Submit a lending offer (pending due diligence) for future acquirers to consider. If an acquirer is interested in purchasing the business with your lending offer, we will reach out to you to finalize details. </div>
									<ul class="ul row">
										<li class="col-sm-12" style="padding-top: 15px; font-size: 20px;">
											Listing #<?php echo $listing_id?>
										</li>
										<li class="col-sm-12">
											<label for="">Are you an accredited investor? Ie. do you make more than 200k a year (for the past 3 years) OR have a net worth of $1M+ (not including your main residence)</label>
											<div class="d-flex radio-flx">
											<label for="" class="custom-radio-box"><input type="radio" name="investor" id="" value="Y" checked> Yes</label>
											<label for="" class="custom-radio-box"><input type="radio" name="investor" id="" value="N"> No</label>
											</div>
										</li>
										<li class="col-sm-12">
											<label for="">What is the maximum amount of money you would lend to an acquirer to purchase this business?</label>
											<input type="text" name="money_lending" id="" value="" placeholder="Aim for 50-80% of the projected purchase price" value="">
										</li>
										<li class="col-sm-6">
											<label for="">What net yearly interest/yield do you require for the money you lend?</label>
											<input type="text" name="yearly_interest" id="" value="" placeholder="Aim for 7-14% yearly interest" value="">
										</li>
										<li class="col-sm-6">
											<label for="">How long of a term would you want your loan to be for?</label>
											<input type="text" name="loan_term" id="" value="" placeholder="Aim for 2-7 years as the time frame" value="">
										</li>
										<li class="col-sm-12">
											<label for="">Which default provision do you require?</label>
											<label for="" class="custom-radio-box"><input type="radio" name="provision" id="" value="Y" checked> Business goes back into possession of lender upon acquirer default.</label>
											<label for="" class="custom-radio-box"><input type="radio" name="provision" id="" value="N"> Acquirer signs personal guarantee on loan.</label>
											
										</li>
										<li class="col-sm-12">
											<label for="">Any other relevant terms to mention?</label>
											<textarea name="terms" id="" cols="30" rows="10" placeholder="Please put here any additional terms for your lending offer to be valid"></textarea>
											
										</li>
										<li class="col-md-4">
											<label for="">Full Name</label>
											<input type="text" name="name" id="" value="" placeholder="John Doe" value="">
										</li>
										<li class="col-md-4">
											<label for="">Email Address</label>
											<input type="text" name="email" id="" value="" placeholder="name@domain.com" value="">
										</li>
										<li class="col-md-4">
											<label for="">Phone Number</label>
											<input type="text" name="phone" id="" value="" placeholder="+X (XXX) XXX-XXXX" value="">
										</li>
										<li class="col-sm-12">
											<button type="submit" id="SubmitLendingOffer" class="btn">Offer Financing</button>
										</li>
									</ul>
									</form>
								</div>
				...
				<?php
					...
					<div class="marketplace-details-para">
						<a href="<?php echo $website?>" class="btn btn_t ml-2<?php echo $checkListingCover > 0 ? ' pgGreen' : ''; ?>" target="_blank"><?php echo $checkListingCover > 0 ? 'View Business Name' : 'View Website'; ?></a>
						<a href="<?php echo $pl_link?>" class="btn btn_t ml-2<?php echo $checkListingCover > 0 ? ' pgGreen' : ''; ?>" target="_blank"><?php echo $checkListingCover > 0 ? 'View Financials' : 'Profit & Loss Statement'; ?></a>
						<?php
						if($google_drive_link !=''){
							?>
						<a href="<?php echo $google_drive_link?>" class="btn btn_t ml-2<?php echo $checkListingCover > 0 ? ' pgGreen' : ''; ?>" target="_blank"><?php echo $checkListingCover > 0 ? 'View Data Room' : 'Other Details'; ?></a>
						<?php
						}
						?>
					</div>
			...
			<div class="multiple-price">
				<ul class="ul row">
					...
					<li class="col-sm-2">
						<div class="box">
							<span><?php echo $pricing_period;?>x</span>
	...
	{
	?>
	<div class="popup_blur_content">
		<div class="btn_group d-flex flex-wrap justify-content-center">
			<h3 class="heading text-center">Please login to see the details.</h3>
			<a href="<?php echo base_url();?>login" class="btn blue-btn">Login</a>
	...
	{
	?>
	<div class="popup_blur"><!-- blur content start here --> 
	<?php
	}
	?>
	<?php
	...
	//print '<pre>';
	//print_r($traffic);
	if(is_array($earnings) && count($earnings)>0 && $earningdataavailable)
	{
		?>
	...
	//print '<pre>';
	//print_r($traffic);
	if(is_array($traffic) && count($traffic)>0 && $trafficdataavailable)
	{
		?>
	...
	</div> <!-- blur content div close here -->
	...
	<section class="section frequently-asked-questions">
		...
		<?php $this->load->view('frontend/listing-uncover-final', $getNDAContent);?>
		</div>
	</section> 
								...
								<div class="col-md-8 latest-list-middleCol">
									<a href="<?php echo base_url();?>listing/<?php echo $rb['listing_id'];?>" class="d-block">
										...
										<div class="starting-price">
											...
											<span class="multiple"><span><?php echo $rb['multiple'];?>Profit Multiple</span></span> <!-- <img src="<?php echo base_url();?>assets/frontend/images/multiple.png" alt=""> -->
										</div>
									</a>
								</div>
	...
	{
	?>
		</div><!-- blur content wrap div close -->
		<?php
	}
	?>
