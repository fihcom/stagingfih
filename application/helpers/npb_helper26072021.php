                                ...
                                <table style="width: 100%;" border:="0"; cellspacing="0";>
                                    ...
                                    <tfoot>
                                        <table style="width: 100%; background-color: #fff; padding: 0 0px; margin: 0 0 0 0;" border:="0"; cellspacing="0";>
                                            <tr style=" padding: 0 0 0 0; margin: 0 0 0 0;">
                                                <td style=" margin: 0 0; padding: 10px 0; font: normal 14px arial; width: 60%; display: inline-block;">Copyright <span>&#169;</span> '.date('Y').' Flat Iron Holdings LLC. All Rights Reserved.</td>
