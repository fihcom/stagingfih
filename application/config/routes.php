...
$route['acquisitionfunding'] = "home/financing";
$route['acquisitionfunding/requestaccess'] = "home/financingrequestaccess";
$route['acquisitionfunding/getfund'] = "home/financinggetfund";
$route['acquisitionfunding/fundacquisition'] = "home/financingfundacquisition";
...
$route['listing/requestfinancingdetails'] = "home/requestfinancingdetails";
$route['listing/becometheceo'] = "home/becometheceo";
$route['listing/lendingoffer'] = "home/lendingoffer";
...
$route['user/sell-your-business'] = "home/sell_your_business";
$route['user/sell-your-business-action'] = "home/sell_your_business_action";
$route['user/sell-your-business/payment'] = "home/businessregpayment";
$route['user/sell-your-business/success'] = "paypal/success";
$route['user/sell-your-business/cancel'] = "paypal/cancel";
$route['user/sell-your-business/apply-promo'] = "home/applyPromo";
...
$route['user/uploadDigitalSignature'] = "user/user/uploadDigitalSignature";
...
// Route Check Digital Signature Upload
$route['user/checkSignatureUploaded'] = "user/user/checkSignatureUploaded";
...
$route['administrator/download-nda/(:num)/(:num)'] = "administrator/administrator/downloadNDA/$1/$2";
...
// ADMIN NDA Content
$route['administrator/nda-content'] = "administrator/contentmanagement/NDAContentListing";
$route['administrator/nda-content/alter'] = "administrator/contentmanagement/alterNDAContent";
...
//$route['administrator/acquisitionlendinglist'] = "administrator/acquisitionlending/list";
$route['administrator/acquisition-lending-list'] = "administrator/acquisitionlending/list";
$route['administrator/add-acquisition'] = "administrator/acquisitionlending/add";
$route['administrator/edit-acquisition/(:num)'] = "administrator/acquisitionlending/add/$1";
$route['administrator/delete-acquisition/(:num)'] = "administrator/acquisitionlending/delete/$1";
$route['administrator/add-acquisition/alter'] = "administrator/acquisitionlending/alter";
$route['administrator/lending-data'] = "administrator/acquisitionlending/lendingData";

$route['administrator/acquisition-lending/contents'] = "administrator/acquisitionlending/contents";
$route['administrator/lending-content/page-image'] = "administrator/acquisitionlending/pageImage";
$route['administrator/lending-content/update-content'] = "administrator/acquisitionlending/updatecontent";

$route['administrator/acquisition-getfund-list'] = "administrator/acquisitionlending/listgetfunded";
$route['administrator/acquisition-businessacquisition-list'] = "administrator/acquisitionlending/listfundacquisition";
$route['administrator/acquisition-requestaccess-list'] = "administrator/acquisitionlending/listrequestaccess";

$route['administrator/requestaccess-data'] = "administrator/acquisitionlending/requestaccessData";
$route['administrator/fundacquisition-data'] = "administrator/acquisitionlending/fundacquisitionData";
$route['administrator/getfunded-data'] = "administrator/acquisitionlending/getfundedData";

$route['administrator/delete-requestaccess/(:num)'] = "administrator/acquisitionlending/deleterequestaccess/$1";
$route['administrator/delete-getfundlist/(:num)'] = "administrator/acquisitionlending/deletegetfundlist/$1";
$route['administrator/delete-fundacquisition/(:num)'] = "administrator/acquisitionlending/deletefundacquisition/$1";
...
$route['administrator/banners'] = "administrator/admincms/bannerscomponents";
$route['administrator/banners/alterbannercontents'] = "administrator/admincms/alterbannercomponents";

$route['administrator/homecontents/addbannerimage'] = "administrator/admincms/addbannerImage";
$route['administrator/homecontents/addbannerimageinner'] = "administrator/admincms/addbannerImageInner";
...
// uncovered-listings-by-user
$route['administrator/uncovered-listings-by-user/(:num)'] = "administrator/administrator/uncoveredListingsByUser/$1";

// Export User Data
$route['administrator/export-users'] = "administrator/administrator/export_users";
...
$route['api/data/updateuserdigitalsignature'] = 'api/user/updateUserDigitalSignature';
$route['api/data/reverifyproofoffund'] = 'api/user/reverifyproofoffund';
$route['api/data/getlendinglist'] = 'api/user/getlendinglist';
...
$route['api/marketplace/requestfinancing'] = 'api/marketplace/requestfinancing';

$route['api/marketplace/becometheceo'] = 'api/marketplace/becometheceo';
$route['api/marketplace/lendingoffer'] = 'api/marketplace/lendingoffer';
...
$route['api/data/financingrequestaccess'] = 'api/user/financingrequestaccess';
$route['api/data/financinggetfund'] = 'api/user/financinggetfund';
$route['api/data/financingfundacquisition'] = 'api/user/financingfundacquisition';
...
$route['api/data/bannercontents'] = 'api/user/bannercontents';
